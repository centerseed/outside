 ...
 */
public class MainActivity_Old extends ToolbarActivity implements LocationListener, chooseCountyFragmentDialog.OnSelectedListener{
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.e(MainActivity_Old.class.getName(), "location: " + location.toString());
        sendBroadcast(BroadcastConst.BROADCAST_GET_LOCATION);
    }
    ...
    private void initUI() {
        ...
        ivLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentDialog.setSelectedListener(MainActivity_Old.this);
    ...
    private void updateLocation() {
        if (checkPermission()) {
            locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 1000, 0, MainActivity_Old.this);
